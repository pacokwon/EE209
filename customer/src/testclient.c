...
/*--------------------------------------------------------------------*/
int TestUnregisterCustomerByID(DB_T d, const char *id,
                               int expected_result) {
    int test_result;
...
/*--------------------------------------------------------------------*/
int TestGetPurchaseByName(DB_T d, const char *name,
                          int expected_result) {
    int test_result;
...
/*--------------------------------------------------------------------*/
int PurchaseLargerThan100(const char *id, const char *name,
                          int purchase) {
    if (purchase > 100)
        return purchase;
    else
